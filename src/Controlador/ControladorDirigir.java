...
public class ControladorDirigir {
    ...
    public void cargarTablaDirigir() {
        ...
        ModeloDirector modeloProductor = new ModeloDirector();
        ModeloEvento modeloSetGrab = new ModeloEvento();

        List<Dirigir> dirigi = modelo.listaDirigirTabla();
        List<Director> productores = modeloProductor.listaProductorTabla();
    ...
    public void cargarRegistroDeProductores() {
        ...
        List<Director> listap = modeloProductor.listaProductorTabla();
    ...
    public void buscarProductor() {
        ...
        KeyListener eventoTeclado = new KeyListener() {//Crear un objeto de tipo keyListener(Es una interface) por lo tanto se debe implementar sus metodos abstractos
            ...
            public void keyReleased(KeyEvent e) {
                ...
                List<Director> listap = modeloProductor.buscarProductor(vista.getTxtBuscarProductor().getText());
