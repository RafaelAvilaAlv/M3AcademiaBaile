...
public class Director extends Empleado {
    ...
    public Director(int pro_codemp, int pro_codigo, int pro_expe, String pro_estado) {
    ...
    public Director(int pro_codemp, int pro_codigo, int pro_expe, String pro_estado, int emp_codigo, int emp_codper, Date emp_fechacontratacion, Double emp_salario) {
